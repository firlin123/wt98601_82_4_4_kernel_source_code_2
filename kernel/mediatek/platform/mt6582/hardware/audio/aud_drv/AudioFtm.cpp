...
int AudioFtm::PhoneMic_Receiver_Loopback(char echoflag)
{
    if (echoflag == MIC1_ON)
    {
        LoopbackManager::GetInstance()->SetLoopbackOn(/*AP_MAIN_MIC_AFE_LOOPBACK*/MD_MAIN_MIC_ACOUSTIC_LOOPBACK, LOOPBACK_OUTPUT_RECEIVER);
    }
    else if (echoflag == MIC2_ON)
    {
        LoopbackManager::GetInstance()->SetLoopbackOn(/*AP_REF_MIC_AFE_LOOPBACK*/MD_REF_MIC_ACOUSTIC_LOOPBACK, LOOPBACK_OUTPUT_RECEIVER);
    }
    else
    {
...
int AudioFtm::PhoneMic_SpkLR_Loopback(char echoflag)
{
    if (echoflag == MIC1_ON)
    {
        LoopbackManager::GetInstance()->SetLoopbackOn(/*AP_MAIN_MIC_AFE_LOOPBACK*/MD_MAIN_MIC_ACOUSTIC_LOOPBACK, LOOPBACK_OUTPUT_SPEAKER);
    }
    else if (echoflag == MIC2_ON)
    {
        LoopbackManager::GetInstance()->SetLoopbackOn(/*AP_REF_MIC_AFE_LOOPBACK*/MD_REF_MIC_ACOUSTIC_LOOPBACK, LOOPBACK_OUTPUT_SPEAKER);
    }
    else
    {
        LoopbackManager::GetInstance()->SetLoopbackOff();
