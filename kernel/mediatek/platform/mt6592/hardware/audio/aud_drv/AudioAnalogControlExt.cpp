...
#if 0//def HP_USING_EXTDAC //Qlw 2013/11/12
...
#endif
            break;
        case AudioAnalogType::VOLUME_VOICECALL_HSOUTL:
        case AudioAnalogType::VOLUME_VOICECALL_HSOUTR:
#ifdef HP_USING_EXTDAC //Qlw 2014/04/08
...
status_t AudioAnalogControlExt::AnalogOpen(AudioAnalogType::DEVICE_TYPE DeviceType, AudioAnalogType::DEVICE_TYPE_SETTING Type_setting)
{
    ...
    switch (DeviceType)
    {
...
#ifdef HP_USING_EXTDAC //Qlw 2014/04/09
                ::ioctl(mFd, SET_EXTCODEC_MUSIC_EARPIECE_OUT, NULL);
#endif
            break;
        ...
        case AudioAnalogType::DEVICE_OUT_HEADSETL:
			...
			::ioctl(mFd, SET_EXTCODEC_GAIN, NULL);
