...
# for huawei proj
WT_HUAWEI_PROJ = no
# Req, panjun.wt, ADD, 140312, To add hotline function.
...
WT_STK_SELECTION = no
# Req_1532 yangqi.wt add for VietNam local apk
WT_SMS_VIETNAM_SUPPORT = no
# Req_1707 yangqi.wt add for flashlight when new call or mms incoming
WT_FLASHLIGHT_WHEN_INCOMING_CALL_MMS = no

#yubosong added for huawei Europe earphone security
WT_EU_EARPHONE_SECURITY = no

#xulichun added for huawei Europe earphone security
WT_PHONE_NUMBER_MATCH_LENGTH = 7
WT_MIKA_REQ_EAP_SIM_SUPPORT = no
WT_SUPPORT_FRONT_CAMERA_LOW_FINE_RECORD = no
