...
{
 if(SP0718_TST_PATTEN==KAL_TRUE)return;
...
void SP0718_Sensor_Init(void)
{
		...
		SP0718_write_cmos_sensor(0xd1,0x03);
		SP0718_write_cmos_sensor(0xfd,0x01);
		SP0718_write_cmos_sensor(0x5b,0x07);
		SP0718_write_cmos_sensor(0x5c,0x2c);
		SP0718_write_cmos_sensor(0xfd,0x01);
		...
		SP0718_write_cmos_sensor(0xfd,0x01);
		SP0718_write_cmos_sensor(0xeb,0x78);
		...
		SP0718_write_cmos_sensor(0x8c,0x0d);
		SP0718_write_cmos_sensor(0x8d,0x1b);
		SP0718_write_cmos_sensor(0x8e,0x29);
		SP0718_write_cmos_sensor(0x8f,0x38);
		SP0718_write_cmos_sensor(0x90,0x4e);
		SP0718_write_cmos_sensor(0x91,0x61);
		SP0718_write_cmos_sensor(0x92,0x72);
		SP0718_write_cmos_sensor(0x93,0x80);
		SP0718_write_cmos_sensor(0x94,0x94);
		SP0718_write_cmos_sensor(0x95,0xa6);
		SP0718_write_cmos_sensor(0x96,0xb7);
		SP0718_write_cmos_sensor(0x97,0xc1);
		SP0718_write_cmos_sensor(0x98,0xca);
		SP0718_write_cmos_sensor(0x99,0xd2);
		SP0718_write_cmos_sensor(0x9a,0xda);
		SP0718_write_cmos_sensor(0x9b,0xe1);
		SP0718_write_cmos_sensor(0x9c,0xe7);
		SP0718_write_cmos_sensor(0x9d,0xec);
		SP0718_write_cmos_sensor(0x9e,0xf3);
		SP0718_write_cmos_sensor(0x9f,0xf9);
		SP0718_write_cmos_sensor(0xa0,0xff);
		SP0718_write_cmos_sensor(0xfd,0x02);
		SP0718_write_cmos_sensor(0x15,0xba);
		SP0718_write_cmos_sensor(0x16,0x90);
		SP0718_write_cmos_sensor(0xa0,0x8c);
		SP0718_write_cmos_sensor(0xa1,0xfa);
		SP0718_write_cmos_sensor(0xa2,0xfa);
		SP0718_write_cmos_sensor(0xa3,0x0c);
		SP0718_write_cmos_sensor(0xa4,0x80);
		...
		SP0718_write_cmos_sensor(0xac,0x80);
		SP0718_write_cmos_sensor(0xad,0x00);
		SP0718_write_cmos_sensor(0xae,0x00);
		SP0718_write_cmos_sensor(0xaf,0xe7);
		SP0718_write_cmos_sensor(0xb0,0xa6);
		...
		SP0718_write_cmos_sensor(0xc3,0xaa);
		SP0718_write_cmos_sensor(0xc4,0x66);
		SP0718_write_cmos_sensor(0xc5,0x22);
		SP0718_write_cmos_sensor(0xfd,0x01);
		SP0718_write_cmos_sensor(0x0f,0xff);
		SP0718_write_cmos_sensor(0x10,0x00);
		SP0718_write_cmos_sensor(0x14,0x10);
		SP0718_write_cmos_sensor(0x11,0x00);
		SP0718_write_cmos_sensor(0x15,0x00);
		SP0718_write_cmos_sensor(0x16,0x0a);
		SP0718_write_cmos_sensor(0xfd,0x01);
		SP0718_write_cmos_sensor(0xfb,0x33);
		SP0718_write_cmos_sensor(0x32,0x15);
		SP0718_write_cmos_sensor(0x33,0xff);
...
kal_uint16 Sp0718SetTestPatternMode(kal_bool bEnable)
{
	...
	{
	      SP0718_TST_PATTEN = KAL_TRUE;
             SP0718_write_cmos_sensor(0xfd,0x01);					
		temp_tst_reg =SP0718_read_cmos_sensor(0x32);					
		SP0718_write_cmos_sensor(0x32, (temp_tst_reg |0x80));	
	}
	else        //disable test pattern output 
	{
	       SP0718_TST_PATTEN = KAL_FALSE;
		SP0718_write_cmos_sensor(0xfd,0x01);					
		temp_tst_reg =SP0718_read_cmos_sensor(0x32);					
		SP0718_write_cmos_sensor(0x32, (temp_tst_reg &0x7f));	
	}
               return ERROR_NONE;
}
...
/****************************************AF END ************************/
       case SENSOR_FEATURE_GET_TRIGGER_FLASHLIGHT_INFO:
		...
		case SENSOR_FEATURE_SET_TEST_PATTERN: //for ata test
		          Sp0718SetTestPatternMode((BOOL) *pFeatureData16);
		break;
		case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE:
		             *pFeatureReturnPara32 = Sp0718_TEST_PATTERN_CHECKSUM;
		             *pFeatureParaLen=4;
		break;
		default:
			break;
