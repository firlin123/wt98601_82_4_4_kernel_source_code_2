...
typedef struct
{
	...
	#define HI545_IMAGE_SENSOR_FULL_WIDTH					(2592)	
	#define HI545_IMAGE_SENSOR_FULL_HEIGHT					(1944)

	/* SENSOR PV SIZE */
	#define HI545_IMAGE_SENSOR_PV_WIDTH						(1296)
	#define HI545_IMAGE_SENSOR_PV_HEIGHT					(972)

	#define HI545_IMAGE_SENSOR_VIDEO_WIDTH					(1296)
	#define HI545_IMAGE_SENSOR_VIDEO_HEIGHT					(972)
