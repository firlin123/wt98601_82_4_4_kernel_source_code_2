...
#define GC0328YUV_TEST_PATTERN_CHECKSUM (0x20d0c802)
 ...
 *
 *************************************************************************/
void GC0328NightMode(UINT16 para)
{
	...
	//	GC0328GammaSelect(GC0328_RGB_Gamma_m5);
		GC0328_NIGHT_MODE = KAL_FALSE;
			...
			case SCENE_MODE_SPORTS:
				GC0328_write_cmos_sensor(0xd5, 0x02);
				GC0328_write_cmos_sensor(0xfe, 0x01);
				GC0328_write_cmos_sensor(0x13, 0x84);
				GC0328_write_cmos_sensor(0xfe, 0x00);
			break;
		}
}
...
GC0328_write_cmos_sensor(0xfe , 0x00);  
	...
	GC0328_write_cmos_sensor(0x82 , 0x1f);// 90
	...
	GC0328_write_cmos_sensor(0x95 , 0x65);// 35
	
	////////////YCP///////////
	GC0328_write_cmos_sensor(0xd1 , 0x28);// 0x30 for front
	GC0328_write_cmos_sensor(0xd2 , 0x28);// 0x30 for front
	GC0328_write_cmos_sensor(0xd3 , 0x46);
...
UINT32 GC0328Open(void)
{
    ...
    printk("lzq_gc0328_sensor_id = 0x%x ", sensor_id);
    printk("lzq_gc0328_sensor_id = 0x%x ", sensor_id);
    if(sensor_id != GC0328_SENSOR_ID)
    {
        SENSORDB("GC0328 Sensor id read failed, ID = %x\n", sensor_id);
...
BOOL GC0328_set_param_wb(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AWB_MODE_DAYLIGHT: //sunny
			...
			GC0328_write_cmos_sensor(0x78, 0x58);
			GC0328_write_cmos_sensor(0x79, 0x6b);		
		break;
		...
		case AWB_MODE_FLUORESCENT:
			...
			GC0328_write_cmos_sensor(0x78, 0x34);
			GC0328_write_cmos_sensor(0x79, 0x4c);
		break;
...
BOOL GC0328_set_param_effect(UINT16 para)
{
	...
	switch (para)
	{
		...
		case MEFFECT_SEPIABLUE:
			GC0328_write_cmos_sensor(0x43 , 0x02);
			GC0328_write_cmos_sensor(0xda , 0x30);
			GC0328_write_cmos_sensor(0xdb , 0x90);
		break;
...
BOOL GC0328_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		 ...
		 case AE_EV_COMP_20:  //+2 EV
			...
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x88);//84
			GC0328_write_cmos_sensor(0xfe, 0x00);
				SENSORDB("[Enter]GC0328 set_param_exposure func:AE_EV_COMP_20\n");	
        break;     
    case AE_EV_COMP_10:  //+1 EV
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x68);
			GC0328_write_cmos_sensor(0xfe, 0x00);
				SENSORDB("[Enter]GC0328 set_param_exposure func:AE_EV_COMP_10\n");
        break;       
    case AE_EV_COMP_00:  // +0 EV
			//GC0328_write_cmos_sensor(0xd5, 0x00);
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x4a);
			GC0328_write_cmos_sensor(0xfe, 0x00);
				SENSORDB("[Enter]GC0328 set_param_exposure func:AE_EV_COMP_00\n");
        break;       
    case AE_EV_COMP_n10:	// -1 EV		
			...
			GC0328_write_cmos_sensor(0xfe, 0x00);
				SENSORDB("[Enter]GC0328 set_param_exposure func:AE_EV_COMP_n10\n");
        break;    
    case AE_EV_COMP_n20:  // -2 EV
    	//GC0328_write_cmos_sensor(0xd5, 0xe0);
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x20);
			GC0328_write_cmos_sensor(0xfe, 0x00);
				
				SENSORDB("[Enter]GC0328 set_param_exposure func:AE_EV_COMP_n20\n");
        break;
...
BOOL GC0328_set_iso(UINT16 para)
{
    switch (para)
    {
        case AE_ISO_AUTO:
...
BOOL GC0328_set_contrast(UINT16 para)
{  
	
    SENSORDB("[Enter]GC0328_set_contrast function:\n ");
   ...
   // return;
    ...
    switch (para)
    {
        ...
        case ISP_CONTRAST_MIDDLE:
	     ...
	     GC0328_write_cmos_sensor(0xd3 , 0x3b);
	    break;
        default:
             break;
    }
...
BOOL GC0328_set_saturation(UINT16 para)
{
	  SENSORDB("[enter] GC0328_set_saturation function:\n ");
	 // if(NT99252_sensor.MPEG4_Video_mode == KAL_TRUE)
        //return;
    switch (para)
    {
        case ISP_SAT_HIGH:
			GC0328_write_cmos_sensor(0xd1 , 0x36);
			GC0328_write_cmos_sensor(0xd2 , 0x36);
             break;
        case ISP_SAT_LOW:
			...
			GC0328_write_cmos_sensor(0xd2 , 0x28);
             break;
        case ISP_SAT_MIDDLE:
			GC0328_write_cmos_sensor(0xd1 , 0x2d);
			GC0328_write_cmos_sensor(0xd2 , 0x2d);
			 break;
        default:
			return KAL_FALSE;
			 break;
...
UINT32 GC0328YUVSensorSetting(FEATURE_ID iCmd, UINT16 iPara)
{
	...
	case FID_SCENE_MODE:
        ...
        break;
    		case FID_AE_ISO:  
         GC0328_set_iso(iPara);
        break; 	    
    case FID_ISP_CONTRAST: 
       GC0328_set_contrast(iPara);
        break;
    case FID_ISP_SAT:  
        GC0328_set_saturation(iPara);
		    break;
    default:
        break;
    }
...
kal_uint16 GC0328SetTestPatternMode(kal_bool bEnable)
{
 SENSORDB("[GC0328SetTestPatternMode] Test pattern enable:%d\n", bEnable);
if(bEnable)    // enable test pattern output 
{
/////test patten ///
			GC0328_write_cmos_sensor(0xfe, 0x00);
			GC0328_write_cmos_sensor(0x09, 0x00); //row_start
			GC0328_write_cmos_sensor(0x0a, 0x00);
			GC0328_write_cmos_sensor(0x0b, 0x00); //col_start
			GC0328_write_cmos_sensor(0x0c, 0x00);
			GC0328_write_cmos_sensor(0x19, 0x06); //AD Pipe line number
			                                
			GC0328_write_cmos_sensor(0x18, 0x06); //sdark
			GC0328_write_cmos_sensor(0x27, 0xb4); 
			GC0328_write_cmos_sensor(0x2a, 0x00); 
			GC0328_write_cmos_sensor(0x2b, 0x00); 
			GC0328_write_cmos_sensor(0x2c, 0x00);
			GC0328_write_cmos_sensor(0x2d, 0x00); 
			GC0328_write_cmos_sensor(0x2e, 0x00); 
			GC0328_write_cmos_sensor(0x2f, 0x00); 
			GC0328_write_cmos_sensor(0x30, 0x00);
			GC0328_write_cmos_sensor(0x31, 0x00); 
			GC0328_write_cmos_sensor(0x33, 0x00); 
			GC0328_write_cmos_sensor(0x34, 0x00); 
			GC0328_write_cmos_sensor(0x35, 0x00);
			GC0328_write_cmos_sensor(0x36, 0x00); 
			GC0328_write_cmos_sensor(0x37, 0x00); 
			GC0328_write_cmos_sensor(0x38, 0x00); 
			GC0328_write_cmos_sensor(0x39, 0x00);
			GC0328_write_cmos_sensor(0x3a, 0x00);
			                                  
			GC0328_write_cmos_sensor(0x40, 0x08); //only intp enable
			...
			GC0328_write_cmos_sensor(0x73, 0x80); //Channel_gain
			GC0328_write_cmos_sensor(0x74, 0x80); 
			GC0328_write_cmos_sensor(0x75, 0x80); 
			GC0328_write_cmos_sensor(0x76, 0x80); 
			                                
			GC0328_write_cmos_sensor(0x4f,  0x00); //AEC_dis
			GC0328_write_cmos_sensor(0x16,  0x00);
			GC0328_write_cmos_sensor(0x03,  0x00);
			GC0328_write_cmos_sensor(0x04,  0x01);
			GC0328_write_cmos_sensor(0x70,  0x40); 
			GC0328_write_cmos_sensor(0x71,  0x40); //AEC gain
			GC0328_write_cmos_sensor(0x72,  0x40); //AEC gain
			                                
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x9e, 0xc0); //ABS tilt
			GC0328_write_cmos_sensor(0x9f, 0x40); 
			                                
			GC0328_write_cmos_sensor(0xfe, 0x00); 
			GC0328_write_cmos_sensor(0xd0, 0x40); //asde saturation
			GC0328_write_cmos_sensor(0xd1, 0x20);
			GC0328_write_cmos_sensor(0xd2, 0x20);
			GC0328_write_cmos_sensor(0xd3, 0x40);
			GC0328_write_cmos_sensor(0xd4, 0x80);
			GC0328_write_cmos_sensor(0xd5, 0x00);
			GC0328_write_cmos_sensor(0xdc, 0x00);
			
			GC0328_write_cmos_sensor(0xdd, 0x00); //edge_sa
			GC0328_write_cmos_sensor(0xde, 0x20); 
			GC0328_write_cmos_sensor(0xe4, 0x00); //auto_gray_enable
			GC0328_write_cmos_sensor(0x99, 0x00);
			GC0328_write_cmos_sensor(0x9d, 0x15);
			GC0328_write_cmos_sensor(0x9f, 0x08);
			GC0328_write_cmos_sensor(0xa1, 0x5f);
			GC0328_write_cmos_sensor(0xa3, 0x45);
			GC0328_write_cmos_sensor(0xa9, 0xff);
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE://for factory mode auto testing             
        *pFeatureReturnPara32=GC0328YUV_TEST_PATTERN_CHECKSUM;
        *pFeatureParaLen=4;                             
         break; 	
    default:
        break;
