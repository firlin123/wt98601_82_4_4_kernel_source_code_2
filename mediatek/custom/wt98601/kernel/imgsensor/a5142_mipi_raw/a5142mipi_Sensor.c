...
UINT32 A5142MIPIGetSensorID(UINT32 *sensorID) 
{
    ...
    for(i = 0; i < sizeof(i2c_addr) / sizeof(i2c_addr[0]); i++)
    {
        ...
        printk("sensor_id_1 = 0x%x\n",sensor_id);
        
        //sensor_id = A5142MIPI_SENSOR_ID;
        printk("liangzhiqiang_20140101_A5142MIPIGetSensorID\n");
...
//kal_uint16 temp=0;
    ...
    printk("sensor_id_0 = 0x%x\n",sensor_id);
    
    //sensor_id = A5142MIPI_SENSOR_ID;
    
    printk("liangzhiqiang_20140101_A5142MIPIOpen\n");
    
    SENSORDB("sensor_id is %x\n ", sensor_id);
...
UINT32 A5142MIPI_read0x3026(void)
{
	...
	printk("###A5142MIPI_read0x3026,adr=%x",adr);
}
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    pSensorInfo->PreviewDelayFrame = 15; 
