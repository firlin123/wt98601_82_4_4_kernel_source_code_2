...
//@hfs---start
#define V_CC2TOPOFF_THRES_LT		3700
#define RECHARGING_VOLTAGE_LT       3790
#define CHARGING_FULL_CURRENT_LT    100	//mA
#define MAX_CV_CHARGING_TIME_LT     4*60*60
...
//@hfs---start
#define WT_BATTERY_TEMP_COMPENSATE 1
#define WT_CHARGING_LOWTEMP_SUPPORT 1
#define WT_CHARGING_TEMPWARNING_STYLE 1
#define WT_CHR_OVERTEMP_RESUME 1
#define WT_CHR_OVP_RESUME 1
#define WT_UI_SOC_SYNC_FULL_IN_CHARGING
#ifdef WT_UI_SOC_SYNC_FULL_IN_CHARGING
 #define WT_UI_SOC_SYNC_FULL_ITERM  300
#endif
//@hfs ---end
#endif /* _CUST_BAT_H_ */ 
