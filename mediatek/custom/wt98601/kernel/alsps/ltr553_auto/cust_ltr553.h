...
/* For ps calibration */
#define CUST_LTR553_PS_THRES_CLOSE		53	 // Close 
#define CUST_LTR553_PS_THRES_FAR		28	 // Far away 
...
#define CUST_LTR553_PS_N_PULSES			0x08 // PS number of pulses				//Number of pulses = 8 
