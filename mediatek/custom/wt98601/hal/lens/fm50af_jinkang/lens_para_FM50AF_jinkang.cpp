...
const NVRAM_LENS_PARA_STRUCT FM50AF_JINKANG_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 FM50AF_jinkang_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &FM50AF_JINKANG_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pFM50AF_jinkang_getDefaultData = FM50AF_jinkang_getDefaultData;
