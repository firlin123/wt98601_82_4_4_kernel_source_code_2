...
#endif
#if defined(FM50AF_JINKANG)
extern PFUNC_GETLENSDEFAULT pFM50AF_jinkang_getDefaultData;
#endif
...
#if defined(FM50AF)
	{A5142MIPI_SENSOR_ID, FM50AF_LENS_ID, "FM50AF", pFM50AF_getDefaultData},
#endif
#if defined(FM50AF_DALING)
...
#if defined(FM50AF_JINKANG)
	{HI545MIPI_SENSOR_ID, FM50AF_LENS_ID, "FM50AF", pFM50AF_jinkang_getDefaultData},
#endif
