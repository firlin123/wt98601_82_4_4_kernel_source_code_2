...
#ifndef _MTK_CUSTOM_PROJECT_HAL_IMGSENSOR_SRC_CONFIGFTBLGC0328YUV_H_
#define _MTK_CUSTOM_PROJECT_HAL_IMGSENSOR_SRC_CONFIGFTBLGC0328YUV_H_
#if 1
//
...
FTABLE_SCENE_INDEP()
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
				ITEM_AS_DEFAULT_("1792x1008"), 
        ITEM_AS_VALUES_(
		 "1024x768", "1280x720",  "1280x960", 
                "1536x864","1600x1200", "1792x1008",
            )
        ), 
    )
#endif
 ...
 ******************************************************************************/
#endif
#endif //_MTK_CUSTOM_PROJECT_HAL_IMGSENSOR_SRC_CONFIGFTBLHI351YUV_H_
