...
#ifndef _MTK_CUSTOM_PROJECT_HAL_IMGSENSOR_SRC_CONFIGFTBLSP0718YUV_H_
#define _MTK_CUSTOM_PROJECT_HAL_IMGSENSOR_SRC_CONFIGFTBLSP0718YUV_H_
#if 1
//
...
FTABLE_SCENE_INDEP()
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                "320x240",      "640x480",      "1024x576",     "1024x768",     "1280x720",
                "1280x960",     "1536x864",     "1600x1200",    "2048x1152",
            )
        ), 
    )
#endif
