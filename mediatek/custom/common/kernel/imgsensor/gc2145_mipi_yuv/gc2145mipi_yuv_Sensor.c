		...
		if (GC2145MIPI_sensor_cap_state == KAL_FALSE) 
		{
			if (enable) 
			{
				...
				else 
				{
					GC2145MIPI_write_cmos_sensor(0xfe, 0x01);
					GC2145MIPI_write_cmos_sensor(0x3c, 0x60);
					GC2145MIPI_write_cmos_sensor(0x13, 0x98);//frank
					GC2145MIPI_write_cmos_sensor(0xfe, 0x00);
				}
			}
			else 
...
static void GC2145MIPI_Sensor_Init(void)
{
	...
	GC2145MIPI_write_cmos_sensor(0x17, 0x14);  // 14
	GC2145MIPI_write_cmos_sensor(0x18, 0x22);
	GC2145MIPI_write_cmos_sensor(0x19, 0x0f);
	...
	GC2145MIPI_write_cmos_sensor(0x81, 0x24);//26
	...
	GC2145MIPI_write_cmos_sensor(0x85, 0x18);//
	...
	GC2145MIPI_write_cmos_sensor(0xc6, 0x38);
	GC2145MIPI_write_cmos_sensor(0xc7, 0x40);
	...
	GC2145MIPI_write_cmos_sensor(0x43, 0x56);//54
	...
	GC2145MIPI_write_cmos_sensor(0x6a, 0x06);
	GC2145MIPI_write_cmos_sensor(0x6b, 0x06);
	GC2145MIPI_write_cmos_sensor(0x6c, 0x06);
	GC2145MIPI_write_cmos_sensor(0x6d, 0x06);
	GC2145MIPI_write_cmos_sensor(0x6e, 0x06);
	GC2145MIPI_write_cmos_sensor(0x6f, 0x06);
	GC2145MIPI_write_cmos_sensor(0x70, 0x06);
	GC2145MIPI_write_cmos_sensor(0x71, 0x06);
	GC2145MIPI_write_cmos_sensor(0x76, 0x00);
	...
	GC2145MIPI_write_cmos_sensor(0x1f, 0x45);//35
	GC2145MIPI_write_cmos_sensor(0x20, 0x40);
	GC2145MIPI_write_cmos_sensor(0x22, 0x40);
	GC2145MIPI_write_cmos_sensor(0x23, 0x20);
	GC2145MIPI_write_cmos_sensor(0xfe, 0x02);
	GC2145MIPI_write_cmos_sensor(0x0f, 0x03);//04
	GC2145MIPI_write_cmos_sensor(0xfe, 0x01);
	GC2145MIPI_write_cmos_sensor(0x12, 0x37);
	...
	GC2145MIPI_write_cmos_sensor(0x40, 0x80);
	...
	GC2145MIPI_write_cmos_sensor(0x86, 0x50);
	GC2145MIPI_write_cmos_sensor(0x87, 0x30);
	GC2145MIPI_write_cmos_sensor(0x88, 0x15);
	GC2145MIPI_write_cmos_sensor(0x89, 0x80);
	GC2145MIPI_write_cmos_sensor(0x8a, 0x60);
	GC2145MIPI_write_cmos_sensor(0x8b, 0x30);
	...
	GC2145MIPI_write_cmos_sensor(0xb6, 0x20);//38
	GC2145MIPI_write_cmos_sensor(0xb7, 0x02);
	GC2145MIPI_write_cmos_sensor(0xb9, 0x32);//28
	GC2145MIPI_write_cmos_sensor(0x3c, 0x04);//08
	GC2145MIPI_write_cmos_sensor(0x3d, 0x20);
	GC2145MIPI_write_cmos_sensor(0x4b, 0x0b);//08
	GC2145MIPI_write_cmos_sensor(0x4c, 0x28);//20
	GC2145MIPI_write_cmos_sensor(0xfe, 0x00);
	...
	///////////////////////////////////////
	GC2145MIPI_write_cmos_sensor(0xfe, 0x02);
	GC2145MIPI_write_cmos_sensor(0x10, 0x10);
	GC2145MIPI_write_cmos_sensor(0x11, 0x15);
	GC2145MIPI_write_cmos_sensor(0x12, 0x1a);
	GC2145MIPI_write_cmos_sensor(0x13, 0x1f);
	GC2145MIPI_write_cmos_sensor(0x14, 0x2c);
	GC2145MIPI_write_cmos_sensor(0x15, 0x39);
	GC2145MIPI_write_cmos_sensor(0x16, 0x45);
	GC2145MIPI_write_cmos_sensor(0x17, 0x54);
	...
	*/
	...
	///////////////////////////////////////////////  
	GC2145MIPI_write_cmos_sensor(0xfe, 0x02);
	GC2145MIPI_write_cmos_sensor(0xd1, 0x34);//30
	GC2145MIPI_write_cmos_sensor(0xd2, 0x34);//30
	GC2145MIPI_write_cmos_sensor(0xd3, 0x40);//43
	...
	GC2145MIPI_write_cmos_sensor(0xee, 0x2b);
	GC2145MIPI_write_cmos_sensor(0xef, 0x3b);
	GC2145MIPI_write_cmos_sensor(0xd8, 0xd8);
  ///////////////////////////ABS////////////////////
  GC2145MIPI_write_cmos_sensor(0xfe, 0x01);
  GC2145MIPI_write_cmos_sensor(0x9f, 0x40);//44
	////////////////////////////
	//////// LSC  0.8///////////////
	////////////////////////////
	GC2145MIPI_write_cmos_sensor(0xfe, 0x01);
	GC2145MIPI_write_cmos_sensor(0xc2, 0x1b);
	GC2145MIPI_write_cmos_sensor(0xc3, 0x15);
	GC2145MIPI_write_cmos_sensor(0xc4, 0x12);
	GC2145MIPI_write_cmos_sensor(0xc8, 0x19);
	GC2145MIPI_write_cmos_sensor(0xc9, 0x12);
	GC2145MIPI_write_cmos_sensor(0xca, 0x10);
	GC2145MIPI_write_cmos_sensor(0xbc, 0x35);
	GC2145MIPI_write_cmos_sensor(0xbd, 0x28);
	GC2145MIPI_write_cmos_sensor(0xbe, 0x22);
	GC2145MIPI_write_cmos_sensor(0xb6, 0x32);
	GC2145MIPI_write_cmos_sensor(0xb7, 0x28);
	GC2145MIPI_write_cmos_sensor(0xb8, 0x21);
	...
	GC2145MIPI_write_cmos_sensor(0xbf, 0x08);
	GC2145MIPI_write_cmos_sensor(0xc0, 0x06);
	GC2145MIPI_write_cmos_sensor(0xc1, 0x00);
	GC2145MIPI_write_cmos_sensor(0xb9, 0x00);
	GC2145MIPI_write_cmos_sensor(0xba, 0x04);
	GC2145MIPI_write_cmos_sensor(0xbb, 0x00);
	GC2145MIPI_write_cmos_sensor(0xaa, 0x16);
	GC2145MIPI_write_cmos_sensor(0xab, 0x10);
	GC2145MIPI_write_cmos_sensor(0xac, 0x10);
	GC2145MIPI_write_cmos_sensor(0xad, 0x23);
	GC2145MIPI_write_cmos_sensor(0xae, 0x24);
	GC2145MIPI_write_cmos_sensor(0xaf, 0x24);
	...
	GC2145MIPI_write_cmos_sensor(0xb4, 0x0b);
	GC2145MIPI_write_cmos_sensor(0xb5, 0x14);
	GC2145MIPI_write_cmos_sensor(0xd0, 0x00);
	GC2145MIPI_write_cmos_sensor(0xd1, 0x00);
	GC2145MIPI_write_cmos_sensor(0xd2, 0x00);
	GC2145MIPI_write_cmos_sensor(0xd6, 0x00);
	GC2145MIPI_write_cmos_sensor(0xd7, 0x06);
	GC2145MIPI_write_cmos_sensor(0xd8, 0x00);
	GC2145MIPI_write_cmos_sensor(0xd9, 0x16);
	...
	GC2145MIPI_write_cmos_sensor(0xfe, 0x01);
	GC2145MIPI_write_cmos_sensor(0xdf, 0x01);
	GC2145MIPI_write_cmos_sensor(0xdc, 0x80);
	GC2145MIPI_write_cmos_sensor(0xdd, 0x30);
	GC2145MIPI_write_cmos_sensor(0xe0, 0x6d);
	GC2145MIPI_write_cmos_sensor(0xe1, 0x60);
	GC2145MIPI_write_cmos_sensor(0xe2, 0x84);//70
	GC2145MIPI_write_cmos_sensor(0xe3, 0x74);//70
	GC2145MIPI_write_cmos_sensor(0xe6, 0x98);
	GC2145MIPI_write_cmos_sensor(0xe7, 0x72);
	GC2145MIPI_write_cmos_sensor(0xe8, 0x98);
	GC2145MIPI_write_cmos_sensor(0xe9, 0x72);
	GC2145MIPI_write_cmos_sensor(0xfe, 0x00);
	GC2145MIPI_write_cmos_sensor(0x17, 0x17);// 17
	GC2145MIPI_write_cmos_sensor(0x0c, 0x08);
	GC2145MIPI_write_cmos_sensor(0x92, 0x08);
	...
	GC2145MIPI_write_cmos_sensor(0x4e, 0x13);
	GC2145MIPI_write_cmos_sensor(0x4c, 0x01);
	GC2145MIPI_write_cmos_sensor(0x4d, 0xce);
	GC2145MIPI_write_cmos_sensor(0x4e, 0x33);
	GC2145MIPI_write_cmos_sensor(0x4c, 0x01);
	GC2145MIPI_write_cmos_sensor(0x4d, 0xcf);
	GC2145MIPI_write_cmos_sensor(0x4e, 0x13);
	GC2145MIPI_write_cmos_sensor(0x4c, 0x01);
	GC2145MIPI_write_cmos_sensor(0x4d, 0xee);
	GC2145MIPI_write_cmos_sensor(0x4e, 0x23);
	GC2145MIPI_write_cmos_sensor(0x4c, 0x01);
	...
	GC2145MIPI_write_cmos_sensor(0x4e, 0x33);
	//GC2145MIPI_write_cmos_sensor(0x4c, 0x01);
	//GC2145MIPI_write_cmos_sensor(0x4d, 0xed);
	//GC2145MIPI_write_cmos_sensor(0x4e, 0x03);//skin
	GC2145MIPI_write_cmos_sensor(0x4c, 0x01);
	...
	GC2145MIPI_write_cmos_sensor(0x4d, 0x0c);
	GC2145MIPI_write_cmos_sensor(0x4e, 0x03);
	//GC2145MIPI_write_cmos_sensor(0x4c, 0x02);
	//GC2145MIPI_write_cmos_sensor(0x4d, 0x2c);
	//GC2145MIPI_write_cmos_sensor(0x4e, 0x03);
	//GC2145MIPI_write_cmos_sensor(0x4c, 0x02);
	//GC2145MIPI_write_cmos_sensor(0x4d, 0x2b);
	//GC2145MIPI_write_cmos_sensor(0x4e, 0x03);
	...
	GC2145MIPI_write_cmos_sensor(0x4c, 0x01); // TL84
	...
	GC2145MIPI_write_cmos_sensor(0x4c, 0x02);
	GC2145MIPI_write_cmos_sensor(0x4d, 0x8a);
	GC2145MIPI_write_cmos_sensor(0x4e, 0x16);//06
	GC2145MIPI_write_cmos_sensor(0x4c, 0x02);
	GC2145MIPI_write_cmos_sensor(0x4d, 0xaa);
	GC2145MIPI_write_cmos_sensor(0x4e, 0x06);
	GC2145MIPI_write_cmos_sensor(0x4c, 0x02);
	...
	GC2145MIPI_write_cmos_sensor(0xC1, 0x44); //48
	GC2145MIPI_write_cmos_sensor(0xc2, 0xfd);//f8
	GC2145MIPI_write_cmos_sensor(0xc3, 0x00);
	GC2145MIPI_write_cmos_sensor(0xc4, 0xf0);
	GC2145MIPI_write_cmos_sensor(0xc5, 0x4b);
	GC2145MIPI_write_cmos_sensor(0xc6, 0xfd);
	GC2145MIPI_write_cmos_sensor(0xC7, 0x44);//50
	GC2145MIPI_write_cmos_sensor(0xc8, 0x00);//f2
	GC2145MIPI_write_cmos_sensor(0xc9, 0x00);
	GC2145MIPI_write_cmos_sensor(0xcA, 0xEc);
	GC2145MIPI_write_cmos_sensor(0xcB, 0x45);
	GC2145MIPI_write_cmos_sensor(0xcC, 0xf2);//ec
	GC2145MIPI_write_cmos_sensor(0xCd, 0x44);//48
	GC2145MIPI_write_cmos_sensor(0xce, 0xf4);
	GC2145MIPI_write_cmos_sensor(0xcf, 0xe8);
	GC2145MIPI_write_cmos_sensor(0xe3, 0x0c);
	GC2145MIPI_write_cmos_sensor(0xe4, 0x48);//4b
	...
	GC2145MIPI_write_cmos_sensor(0x08, 0x14);
	GC2145MIPI_write_cmos_sensor(0xfe, 0x01);
	...
	GC2145MIPI_write_cmos_sensor(0x29, 0x05);
	GC2145MIPI_write_cmos_sensor(0x2a, 0xdc);
	GC2145MIPI_write_cmos_sensor(0x2b, 0x09);
	GC2145MIPI_write_cmos_sensor(0x2c, 0xc4);
...
static void GC2145MIPI_Sensor_SVGA(void)
{
	...
	GC2145MIPI_write_cmos_sensor(0x07, 0x24);
	GC2145MIPI_write_cmos_sensor(0x08, 0x40);
	GC2145MIPI_write_cmos_sensor(0x0a, 0x82);
...
static void GC2145MIPI_Sensor_2M(void)
{
	...
	GC2145MIPI_write_cmos_sensor(0x07, 0x40);
	GC2145MIPI_write_cmos_sensor(0x08, 0x80);
	GC2145MIPI_write_cmos_sensor(0x0a, 0x82);
	GC2145MIPI_write_cmos_sensor(0x21, 0x15);
	GC2145MIPI_write_cmos_sensor(0xfe, 0x00);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    //GC2145MIPI_write_cmos_sensor(0xfe, 0x01);
	//printk("frank0x13=0x%x\n", GC2145MIPI_read_cmos_sensor(0x13));
	//printk("frank0x0a=0x%x\n", GC2145MIPI_read_cmos_sensor(0x0a));
...
BOOL GC2145MIPI_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2145MIPI_write_cmos_sensor(0x2c, 0xd6);
		GC2145MIPI_write_cmos_sensor(0x2d, 0x0b);
		GC2145MIPI_write_cmos_sensor(0x2e, 0xb8);
		GC2145MIPI_write_cmos_sensor(0xfe, 0x00);
            break;
		...
		GC2145MIPI_write_cmos_sensor(0x29, 0x05);
		GC2145MIPI_write_cmos_sensor(0x2a, 0xb0);
		GC2145MIPI_write_cmos_sensor(0x2b, 0x06);
		GC2145MIPI_write_cmos_sensor(0x2c, 0x80);
		GC2145MIPI_write_cmos_sensor(0x2d, 0x0b);
...
BOOL GC2145MIPI_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_n10:
			GC2145MIPI_SET_PAGE1;
			GC2145MIPI_write_cmos_sensor(0x13,0x50);//15
			GC2145MIPI_SET_PAGE0;
		break;
		case AE_EV_COMP_n07:
			GC2145MIPI_SET_PAGE1;
		...
		case AE_EV_COMP_00:
			GC2145MIPI_SET_PAGE1;
			GC2145MIPI_write_cmos_sensor(0x13,0x7b);//30
			GC2145MIPI_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2145MIPI_SET_PAGE1;
