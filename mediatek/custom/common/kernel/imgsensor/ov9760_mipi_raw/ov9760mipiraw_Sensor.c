 ...
 *  void
 *****************************************************************************/
void OV9760MIPI_set_dummy(const kal_uint16 iPixels, const kal_uint16 iLines)
{
...
static kal_uint32 OV9760MIPI_GetSensorID(kal_uint32 *sensorID)
{
	...
	for(i = 0; i <(sizeof(sccb_writeid)/sizeof(sccb_writeid[0])); i++)
	{
		...
		SENSORDB("OV9760MIPI Sensor Read OV9760MIPI ID %x \r\n",(unsigned int)sensor_id);
	...
	{
	    *sensorID=0xFFFFFFFF;
	    SENSORDB("OV9760MIPI Sensor Read ByeBye \r\n");
...
void OV9760MIPI_Set720P(void)
{
	...
	OV9760MIPI_write_cmos_sensor(0x3091, 0x29); //;PLL control  //28
