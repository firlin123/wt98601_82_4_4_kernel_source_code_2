...
#define CUST_KEY_VOLUP		KEY_VOLUMEUP//KEY_BACK//zhaoqf_sh
...
#define CUST_KEY_CONFIRM	KEY_HOME//KEY_POWER//zhaoqf_sh
#define CUST_KEY_BACK		KEY_BACK//KEY_VOLUMEUP//zhaoqf_sh
