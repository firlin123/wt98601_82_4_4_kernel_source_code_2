...
# Generated at 2014-02-20 23:32:49
...
# ------------------------------ Verno information
VERNO = MOLY.WR8.W1315.MD.WG.MP.V34.P19
BUILD = BUILD_NO
...
BOARD_VER = WINGTECH82_CWET_KK_BB
  # Description:
...
CUSTOM_OPTION += WINGTECH_NVRAM_EF_TEST_AND_CALIBRATION
#==============
  
CUSTOM_OPTION += 
# if you want to ture off L1_EPSK_TX please add following custom option
#CUSTOM_OPTION += __EPSK_TX_SW_SWITCH_OFF
CUSTOM_OPTION += WT_DATA_REGION_IMEI_PROTECTION
# internal configuration
PROJECT_MAKEFILE_EXT = WINGTECH82_CWET_KK_HSPA_EXT
