...
#define DISP_IOCTL_GET_GAMMAPARAM_FROM_LCDDRV  _IOR  (DISP_IOCTL_MAGIC, 63 , DISP_PQ_PARAM)
#define DISP_IOCTL_GET_PQPARAM_FROM_LCDDRV  _IOR  (DISP_IOCTL_MAGIC, 64 , DISP_PQ_PARAM)
#endif
