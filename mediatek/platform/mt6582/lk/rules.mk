...
ifeq ($(WT_BRIGHTNESS_MAPPING_WITH_LCM), yes)
	DEFINES += WT_BRIGHTNESS_MAPPING_WITH_LCM
endif	 

ifeq ($(WT_BACKLIGHT_DISABLE_WITH_NOLCM), yes)
	DEFINES += WT_BACKLIGHT_DISABLE_WITH_NOLCM
endif	
...
LIBSEC := -L$(LOCAL_DIR)/lib -lsec -ldisplay
else
LIBSEC := -L$(LOCAL_DIR)/lib -lsec -ldisplay -lauth
endif
