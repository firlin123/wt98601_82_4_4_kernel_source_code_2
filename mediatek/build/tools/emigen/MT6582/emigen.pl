...
#Req,sunzheng.wt.ADD,20140507, add for get EMMC flash info in factory mode
...
if ($os eq "windows")
{
	...
	#Req,sunzheng.wt.ADD,20140507, add for get EMMC flash info from factory mode
...
#3 LPDDR3    
		...
		#Req,sunzheng.wt.ADD,20140422, add for get EMMC flash info from factory mode
